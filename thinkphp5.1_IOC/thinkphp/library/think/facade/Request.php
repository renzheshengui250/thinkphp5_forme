 ...
 * @method \think\Request create(string $uri, string $method = 'GET', array $params = [], array $cookie = [], array $files = [], array $service = [], string $content = null) static 创建一个URL请求
 ...
 * @method mixed service(string $name = '', mixed $default = null, mixed $filter = '') static 获取server参数
