...
//		for PDF files, and its directory location on your service
...
//	Change these values to select the Rendering library that you wish to use
//		for Chart images, and its directory location on your service
...
foreach($inputFileNames as $inputFileName) {
	...
	echo date('H:i:s') , " Load TestModel from $inputFileType file " , $inputFileNameShort , EOL;
