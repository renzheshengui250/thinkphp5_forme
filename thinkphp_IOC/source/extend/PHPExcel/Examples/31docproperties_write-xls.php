...
$objPHPExcel->getProperties()->setTitle("Office 95 XLS TestModel Document")
							 ->setSubject("Office 95 XLS TestModel Document")
							 ->setDescription("TestModel XLS document, generated using PHPExcel")
