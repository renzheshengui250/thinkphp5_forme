...
//                                                echo 'Default', PHP_EOL;
    ...
    //                                    echo 'Value is ', $value, PHP_EOL;
                    ...
                    if ((!$this->readDataOnly) || (!empty($this->loadSheetsOnly))) {
                        // active sheet wx
                        $activeTab = intval($xmlWorkbook->bookViews->workbookView["activeTab"]); // refers to old sheet wx

                        // keep active sheet wx if sheet is still loaded, else first sheet is set as the active
