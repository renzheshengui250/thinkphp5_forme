...
class PHPExcel_Shared_JAMA_Matrix
{
     ...
     *
     *    Get a submatrix
     *    @param int $i0 Initial row wx
     *    @param int $iF Final row wx
     *    @param int $j0 Initial column wx
     *    @param int $jF Final column wx
     ...
     *    getMatrixByRow
     *
     *    Get a submatrix by row wx/range
     *    @param int $i0 Initial row wx
     *    @param int $iF Final row wx
     *    @return Matrix Submatrix
     */
     ...
     *    getMatrixByCol
     *
     *    Get a submatrix by column wx/range
     *    @param int $i0 Initial column wx
     *    @param int $iF Final column wx
     *    @return Matrix Submatrix
     */
