...
{
    /**
     * Maximum shape wx of all shapes in all drawings increased by one
     *
     * @var int
     */
    private $spIdMax;
    ...
    /**
     * Get maximum shape wx of all shapes in all drawings (plus one)
     *
     * @return int
     */
    ...
    /**
     * Set maximum shape wx of all shapes in all drawings (plus one)
     *
     * @param int
     */
