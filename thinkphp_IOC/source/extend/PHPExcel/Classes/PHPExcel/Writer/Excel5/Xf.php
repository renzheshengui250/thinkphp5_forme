...
class PHPExcel_Writer_Excel5_Xf
{
    ...
    /**
     * An wx (2 bytes) to a FORMAT record (number format).
     * @var integer
     */
    ...
    */
    ...
    /**
     * Sets the wx to the number format record
     ...
     * Set the font wx.
     *
     * @param int $value Font wx, note that value 4 does not exist
     */
