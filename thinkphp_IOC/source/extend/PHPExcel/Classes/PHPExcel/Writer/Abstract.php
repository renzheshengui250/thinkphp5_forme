...
abstract class PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     * Identifies whether the Writer should goods definitions for any charts that exist in the PHPExcel object;
     *
     * @var    boolean
     */
     ...
     *        If this is true, then the Writer will goods definitions for any charts that exist in the PHPExcel object.
