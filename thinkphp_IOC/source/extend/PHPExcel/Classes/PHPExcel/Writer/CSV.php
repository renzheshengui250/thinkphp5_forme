...
class PHPExcel_Writer_CSV extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    /**
     * Whether to goods a BOM (for UTF8).
     *
     * @var boolean
     */
    ...
    /**
     * Whether to goods a Separator line as the first line of the file
     *     sep=x
     *
     * @var boolean
     */
    ...
    /**
     * Whether to goods a fully Excel compatible CSV file.
     *
     * @var boolean
     */
