...
class PHPExcel_Worksheet_AutoFilter
{
    ...
    /**
     *    TestModel if cell value is in the defined set of values
     *
    ...
    /**
     *    TestModel if cell value is in the defined set of Excel date values
     *
     *    @param    mixed        $cellValue
     *    @param    mixed[]        $dataSet
     *    @return boolean
    ...
    /**
     *    TestModel if cell value is within a set of values defined by a ruleset
     *
     *    @param    mixed        $cellValue
     *    @param    mixed[]        $ruleSet
     *    @return boolean
    ...
    /**
     *    TestModel if cell date value is matches a set of values defined by a set of months
     *
     *    @param    mixed        $cellValue
        ...
        foreach ($this->columns as $columnID => $filterColumn) {
            ...
            switch ($filterColumn->getFilterType()) {
                case PHPExcel_Worksheet_AutoFilter_Column::AUTOFILTER_FILTERTYPE_FILTER:
                    ...
                    //    TestModel if we want to include blanks in our filter criteria
                    $blanks = false;
...
//        echo 'Column Filter TestModel CRITERIA',PHP_EOL;
