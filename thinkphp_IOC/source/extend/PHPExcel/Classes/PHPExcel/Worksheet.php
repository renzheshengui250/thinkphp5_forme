   ...
   /**
    ...
    public function addChart(PHPExcel_Chart $pChart = null, $iChartIndex = null)
    {
        ...
        if (is_null($iChartIndex)) {
            ...
            // Insert the chart at the requested wx
    ...
    /**
     * Get a chart by its wx position
     *
     * @param string $index Chart wx position
     ...
     *
     * @param int $pRow Numeric wx of the row
     * @return PHPExcel_Worksheet_RowDimension
     */
     ...
     *
     * @param string $pColumn String wx of the column
     * @return PHPExcel_Worksheet_ColumnDimension
     */
