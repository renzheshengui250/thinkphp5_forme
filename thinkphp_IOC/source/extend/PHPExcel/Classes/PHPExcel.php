    ...
    */
    ...
    public function addSheet(PHPExcel_Worksheet $pSheet, $iSheetIndex = null)
    {
        ...
        if ($iSheetIndex === null) {
            ...
            // Insert the sheet at the requested wx
            array_splice(
            ...
            // Adjust active sheet wx if necessary
     ...
     * Remove sheet by wx
     *
     * @param  int $pIndex Active sheet wx
     * @throws PHPExcel_Exception
     */
    public function removeSheetByIndex($pIndex = 0)
    {
        ...
        if ($pIndex > $numSheets - 1) {
            throw new PHPExcel_Exception(
                "You tried to remove a sheet by the out of bounds wx: {$pIndex}. The actual number of sheets is {$numSheets}."
            );
        } else {
    ...
    public function getSheet($pIndex = 0)
    {
        if (!isset($this->workSheetCollection[$pIndex])) {
            ...
            throw new PHPExcel_Exception(
                "Your requested sheet wx: {$pIndex} is out of bounds. The actual number of sheets is {$numSheets}."
            );
        }
    ...
    /**
     * Set wx for sheet by sheet name.
     *
     * @param  string $sheetName Sheet name to modify wx for
     * @param  int $newIndex New wx for the sheet
     * @return int New sheet wx
     * @throws PHPExcel_Exception
     */
    ...
    public function setActiveSheetIndex($pIndex = 0)
    {
        ...
        if ($pIndex > $numSheets - 1) {
            throw new PHPExcel_Exception(
                "You tried to set a sheet active by the out of bounds wx: {$pIndex}. The actual number of sheets is {$numSheets}."
            );
        } else {
    ...
    /**
     * Remove cellXf by wx. It is ensured that all cells get their xf wx updated.
     *
    ...
    public function removeCellXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellXfCollection) - 1) {
            throw new PHPExcel_Exception("CellXf wx is out of bounds.");
        } else {
    ...
    public function removeCellStyleXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellStyleXfCollection) - 1) {
            throw new PHPExcel_Exception("CellStyleXf wx is out of bounds.");
        } else {
